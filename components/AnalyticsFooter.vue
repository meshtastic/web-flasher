<template>
  ...
  >
    <div class="max-w-7xl mx-auto flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
      <p class="text-sm">
        We collect anonymous crash and usage data across this app. This helps us improve Meshtastic. No personally identifiable data is collected. See our <a href="https://meshtastic.org/docs/legal/privacy/" target="_blank" class="underline text-blue-400 hover:text-blue-300">Privacy Policy</a> for more details.
      </p>
      <button
        type="button"
