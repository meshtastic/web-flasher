<template>
    <div class="flex flex-col items-center p-2 w-56">
        ...
        <div class="flex justify-start w-full">
            ...
            <CheckBadgeIcon v-if="isSupporterDevice(props.device)" class="w-6 h-6 m-1 pb-1 text-green-400" />
            <ShieldExclamationIcon v-else class="w-6 h-6 m-1 pb-1 text-yellow-400" />
        </div>
