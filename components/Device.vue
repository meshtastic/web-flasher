<template>
    <div>
        <button id="dropdownDeviceButton" data-dropdown-toggle="dropdownDevices" class="display-inline content-center text-black meshtastic-bg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">
